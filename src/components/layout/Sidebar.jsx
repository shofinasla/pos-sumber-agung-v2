      ...
      >
        ...
        <div className="h-16 px-4 flex items-center justify-between border-b border-slate-800 bg-slate-950/50">
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              <h1 className="font-black text-white text-sm tracking-tight leading-none">TB. SUMBER AGUNG</h1>
              <span className="text-[10px] font-semibold text-rose-400 uppercase tracking-widest block mt-0.5">
                Toko Bangunan & POS
              </span>
            </div>
          </div>
